...
package in.arcadelabs.lifesteal.core;
...
import in.arcadelabs.lifesteal.api.Interaction;
...
import in.arcadelabs.lifesteal.core.api.impl.StatisticsManager;
import in.arcadelabs.lifesteal.core.api.impl.database.DatabaseHandler;
import in.arcadelabs.lifesteal.core.api.impl.profile.ProfileListener;
import in.arcadelabs.lifesteal.core.api.impl.profile.ProfileManager;
import in.arcadelabs.lifesteal.core.commands.AddHearts;
import in.arcadelabs.lifesteal.core.commands.Eliminate;
import in.arcadelabs.lifesteal.core.commands.GiveHearts;
import in.arcadelabs.lifesteal.core.commands.Reload;
import in.arcadelabs.lifesteal.core.commands.RemoveHearts;
import in.arcadelabs.lifesteal.core.commands.Revive;
import in.arcadelabs.lifesteal.core.commands.SetHearts;
import in.arcadelabs.lifesteal.core.commands.Withdraw;
import in.arcadelabs.lifesteal.core.listeners.*;
import in.arcadelabs.lifesteal.core.utils.FancyStuff;
import in.arcadelabs.lifesteal.core.utils.LogFilter;
import in.arcadelabs.lifesteal.core.utils.RecipeLoader;
import in.arcadelabs.lifesteal.core.utils.SpiritFactory;
import in.arcadelabs.lifesteal.core.utils.Utils;
...
public class LifeSteal {
  ...
  private void databaseInit() {
    try {
      ...
      this.databaseHandler = new DatabaseHandler(this.instance, this.config);
  ...
  private void profilesInit() {
    try {
      this.IProfileManager = new ProfileManager(this.databaseHandler, this.config, this.logger);
  ...
  private void recipesInit() {
    try {
      ...
      Bukkit.removeRecipe(this.recipeLoader.getHeartRecipe().getKey());
      this.instance.getServer().addRecipe(this.recipeLoader.getHeartRecipe());
  ...
  private void registerListeners() {
    try {
      final Listener[] listeners = {
              ...
              new ProfileListener(this.instance, this.IProfileManager, this.databaseHandler, this.logger),
      };
  ...
  private void registerServices() {
    this.instance.getServer().getServicesManager().register(LifeStealAPI.class, new LifeStealAPI() {
      @Override
      public @NonNull IProfileManager getProfileManager() {
        return IProfileManager;
      }

      @Override
      public @NotNull IStatisticsManager getStatisticsManager() {
        return IStatisticsManager;
      }

      @Override
      public @NonNull HeartItemManager getHeartItemManager() {
        return heartItemManager;
      }

      @Override
      public @NonNull ShapedRecipe getHeartRecipeManager() {
        return recipeLoader.getHeartRecipe();
      }

      @Override
      public @NonNull ItemStack getPlaceholderHeart() {
        return placeholderHeart;
      }

      @Override
      public @NonNull Interaction getInteraction() {
        return interaction;
      }
      ...
      @Override
      public @NonNull NamespacedKeyBuilder getNamespacedKeyBuilder() {
        return namespacedKeyBuilder;
      }
